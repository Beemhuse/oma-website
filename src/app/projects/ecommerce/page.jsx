    ...
    <section className="bg-[#FFFFFFB2] dark:bg-inherit font-[inter]">
      <div className="p-3 md:p-[60px] flex  md:flex-row flex-col-reverse justify-between items-start gap-4">
        <div className="w-full md:w-[30%] ">
          <div>
            <h3 className="font-[inter] 2xl:text-[50px] lg:text-[50px] font-bold">
              E-commerce
            </h3>
            <p className="text-[15.5px]">
            We develop and support online platforms that boost African businesses and connect them to global markets.            </p>
          </div>
        </div>
