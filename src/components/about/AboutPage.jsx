...
import core5 from "../../../public/account.avif";
import core6 from "../../../public/open.jpg";
import core7 from "../../../public/sustainability.png";
import core8 from "../../../public/innovation.webp";
        ...
        <div className=" flex flex-col justify-between lg:flex-row items-center">
          ...
          <div id="mission" className=" lg:w-1/3 mb-8 lg:mb-0">
            ...
            <p className="text-black/70 dark:text-white mb-6">
              One Map Africa is dedicated to promoting dialogue, collaboration,
              and integration among African nations, to create a unified
              continent with a common purpose. We facilitate open communication
              and encourage cooperative efforts to achieve this vision.
            </p>
            <button
        ...
        <div className="max-w-6xl mx-auto flex h-full gap-5">
          ...
          <div className="grid grid-cols-1 md:coreBox gap-8 overflow-scroll no-scrollbar">
            ...
            <div className="bg-white text-black rounded-2xl border p-6  md:core2">
              <Image src={core1} width={40} alt="core1" />
            ...
            <div className="bg-white text-black rounded-2xl p-6 border  md:core3">
              <Image src={core2} width={40} alt="core2" />
            ...
            <div className="bg-white text-black border rounded-2xl p-6  md:core4">
              <Image src={core3} width={40} alt="core3" />
            ...
            <div className="bg-white text-black border rounded-2xl p-6  md:core5">
              <Image src={core4} width={40} alt="core4" />
            ...
            {/* Accountability */}
            <div className="bg-white text-black border rounded-2xl p-6  md:core6">
              <Image src={core5} width={40} alt="core4" />
            ...
            {/* Openness */}
            <div className="bg-white text-black border rounded-2xl p-6  md:core7">
              <Image src={core6} width={40} alt="core7" />
            ...
            {/* Sustainability: */}
            <div className="bg-white text-black border rounded-2xl p-6  md:core8">
              <Image src={core7} width={40} alt="core4" />
              <h3 className="text-xl font-bold mb-2">Sustainability</h3>
              <p className="text-gray-600">
                We are committed to long-term, environmentally and socially
                responsible practices.{" "}
              </p>
            </div>
            {/* Innovation: */}
            <div className="bg-white text-black border rounded-2xl p-6  md:core9">
              <Image src={core8} width={40} alt="core9" />
