...
export function VerifyIDCardContent() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
       <Card className="max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle
              className={`text-center ${data?.isValid ? "text-green-500" : "text-red-500"}`}
            >
          ...
          <CardContent>
            {data?.isValid ? (
              ...
              <div className="text-center space-y-4">
                <p>
                  The ID card with number <strong>{cardId}</strong> could not be
                  verified.
                </p>
